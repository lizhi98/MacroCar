...
#define MT9V03X_W               (188)                                             // 总钻风摄像头1 图像宽度     范围 [1-752]
#define MT9V03X_H               (120)                                             // 总钻风摄像头1 图像高度     范围 [1-480]
...
#define MT9V03X_1_EXP_TIME_DEF    ( 150 )                                           // 总钻风摄像头1 曝光时间       摄像头收到后会自动计算出最大曝光时间，如果设置过大则设置为计算出来的最大曝光值
#define MT9V03X_1_FPS_DEF         ( 150 )                                            // 总钻风摄像头1 图像帧率       摄像头收到后会自动计算出最大FPS，如果过大则设置为计算出来的最大FPS
