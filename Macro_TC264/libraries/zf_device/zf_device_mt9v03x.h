...
// #define MT9V03X_COF_IIC_DELAY   (800)                                             // 总钻风摄像头1 IIC 延时
// #define MT9V03X_COF_IIC_SCL     (P33_13)                                          // 总钻风摄像头1 IIC-SCL 引脚
// #define MT9V03X_COF_IIC_SDA     (P32_4)                                           // 总钻风摄像头1 IIC-SDA 引脚

// #define MT9V03X_DMA_CH          (IfxDma_ChannelId_7)

// #define MT9V03X_PCLK_PIN        (ERU_CH1_REQ10_P14_3)                             // 总钻风摄像头1 PCLK 触发信号 TIM_ETR 引脚禁止随意修改
// #define MT9V03X_VSYNC_PIN       (ERU_CH4_REQ8_P33_7)                              // 总钻风摄像头1 场中断引脚

// #define MT9V03X_DATA_PIN        (P00_0)                                           // 总钻风摄像头1 数据引脚 这里是 只能是 GPIOx0 或者 GPIOx8 开始 连续八个引脚例如 P00_0-P00_7
...
// #define MT9V03X_EXP_TIME_DEF    ( 170 )                                         // 曝光时间         摄像头收到后会自动计算出最大曝光时间，如果设置过大则设置为计算出来的最大曝光值
