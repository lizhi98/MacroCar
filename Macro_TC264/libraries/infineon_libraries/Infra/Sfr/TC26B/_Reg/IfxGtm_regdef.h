...
typedef struct _Ifx_GTM_DPLL_IRQ_NOTIFY_Bits
{
    ...
    Ifx_Strict_32Bit TINI:1;                /**< \brief [2:2] TRIGGER minimum hold time violation interrupt (Úê¡Õôí) (rwh) */
    Ifx_Strict_32Bit TAXI:1;                /**< \brief [3:3] TRIGGER maximum hold time violation interrupt (Úê¡Õôí>THMA>0) (rwh) */
...
/** \brief  TOM Channel Control RegisterÚêÑ´┐¢ */
...
{
    Ifx_GTM_TOM_CH_CTRL CTRL;               /**< \brief 0, TOM Channel Control RegisterÚêÑ´┐¢ */
